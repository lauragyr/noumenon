// socket stuff
let ip = "10.155.113.55"; // laura's ip-adresse wlan
//let ip = "127.0.0.1";
...
q2a6.addEventListener('click', function(){setQ2Value(6)});
...
q9a5.addEventListener('click', function(){setQ9Value(5)});
var q9a6 = document.getElementById('q9a6'); // grab a reference to your element
q9a6.addEventListener('click', function(){setQ9Value(6)});
...
q10a5.addEventListener('click', function(){setQ10Value(5)});
var q10a6 = document.getElementById('q10a6'); // grab a reference to your element
q10a6.addEventListener('click', function(){setQ10Value(6)});
...
q11a5.addEventListener('click', function(){setQ11Value(5)});
var q11a6 = document.getElementById('q11a6'); // grab a reference to your element
q11a6.addEventListener('click', function(){setQ11Value(6)});
...
q13a5.addEventListener('click', function(){setQ13Value(5)});
var q13a6 = document.getElementById('q13a6'); // grab a reference to your element
q13a6.addEventListener('click', function(){setQ13Value(6)});
